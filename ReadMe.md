## *GeoPatch* is a package for generating patches from remote sensing data [![PyPI version](https://badge.fury.io/py/GeoPatch.svg)](https://pypi.org/project/pyrsgis/) [![Downloads](https://pepy.tech/badge/geopatch)](https://pepy.tech/project/geopatch) 
